...
xmlhttp.open("GET","http://localhost:8051", true);
...
function valid_squares(src) {
    pos = [];
    //alert("valid_squares func started");
    //alert(src);
    var s = Number(src);
    var temp;
...
//$("#chessboard #" + "114").children("img").remove();
...
//  myCol = $(this).index();
//myRow = $(this).parent().index();   
//    myCol = notation[myCol];
//  logging(myCol);   
//logging(8 - myRow + " ");
//});
//var curr_selected;
